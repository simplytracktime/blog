...
Much like a bridge or a kitchen floor, people expect a software system to be maintainable and provide reliable service for its operational life. If the mainframe systems used in the banking industry are indicative this will be much longer than anyone expects.

Actions:

1. Estimate the life expectancy of the system you are working on and make design choices accordingly.
...
1. Given the above, what are the consequences if the runtime, a core dependency, the environment is "end-of-life", undermining the system.
